                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <!-- <div class="section-title">Responsive</div> -->
                     ...
                     <?php  
                      $adminquery="SELECT * FROM tblmagazine t, tblacyear a
                              WHERE a.acyearid=t.acyearid
                              AND t.enddate> now()";
                          ...
                          <?php  
                            ...
                            { 
                              ...
                              echo "<tr>";
                                ...
                                // echo "<td>$titleID</td>";
                                echo "<input type='hidden' name='txtmagazineid' value='$titleID'>";
                                ...
                                echo "<td>
                                    <a href='upload_article.php?MagazineID=$titleID'>Contribute</a>
                                    </td>";
                              echo "</tr>";
                            }
                            ?>
