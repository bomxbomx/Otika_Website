  ...
  if(isset($_POST['btnregister']))
  {
    ...
    // else{
          $insert=mysqli_query($connection,"INSERT INTO
           tblstudent (studentid,name,email,username, password,address,phone)
           VALUES ( '$studentid','$name','$email','$username','$password','$address','$phone')");
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form action="#" method="post">
                  ...
                  <div class="form-group">
                    <label for="frist_name">Phone</label>
                      <input type="text" name="txtphone" id="name" required="" class="form-control" autofocus/>
                  </div>

                  <div class="form-group">
                    <label for="frist_name">Address</label>
                      <input type="text" name="txtaddress" id="name" required="" class="form-control" autofocus/>
                  </div>
              ...
              <div class="mb-4 text-muted text-center">
                Already Registered? <a href="studentlogin.php">Login</a>
              </div>
            </div>
          </div>
        </div>
