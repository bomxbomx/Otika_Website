              ...
              <div class="col-12 ">
                ...
                <div class="card">
                  <div class="card-header">
                    <h4>Percentage of Contributions for each academic year</h4>
                  </div>
                  <div class="card-body">
                    <!-- <div class="section-title">Responsive</div> -->
                      ...
                      <?php  
                      $adminquery="SELECT * FROM reportpercentage p, tblmagazine d, tblacyear a
                              WHERE d.acyearid=a.acyearid
                              AND a.acyear=p.acyear";
