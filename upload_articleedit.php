              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <h4>Article Upload Edit Form</h4>
                  </div>
                  <div class="card-body">
                    <div class="form-group">
                      <label>Date</label>
                      <input type="text" name="txtdate" id="name" readonly="" value="<?php echo $date;?>" class="form-control" />
                    </div>

                    <div class="form-group">
                      <label>File Name</label>
                      <input type="text" name="txtfilename" id="name" required="" value="<?php echo $filename;?>" class="form-control" />
                    </div>
                  ...
                  <div class="card-footer text-right">
                    <button class="btn btn-primary mr-1" name="btnupdate" type="submit">Update</button>
