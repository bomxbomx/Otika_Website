...
if (isset($_POST['btnlogin'])) 
{
    ...
    if($count==0)
    {
        ...
        {
            echo '<script type="text/javascript">alert("Username and Password incorrect!");
    ...
    else
    {
        ...
        echo '<script type="text/javascript">alert("Success");
                   window.location.href="magazinelist.php";</script>';
    }
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="mt-5 text-muted text-center">
              Don't have an account? <a href="studententry.php">Create One</a>
            </div>
          </div>
        </div>
      </div>
